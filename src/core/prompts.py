...
4. For optional OBJECT fields (such as "tpaOrganisation"), if NONE of the sub-fields can be found in the document, set the entire object to null instead of returning an object filled with empty strings.
