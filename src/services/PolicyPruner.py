...
class PolicyPruner:
    def __init__(self):
        raw_keywords = [
            ...
            "definition", "annexure", "appendix", "appendices", "cancellation", "arbitration",
            "fraud", "free look", "renewal", "portability", "migration",
            "withdrawal", "moratorium", "nomination", "assignment", "redressal"
        ]
